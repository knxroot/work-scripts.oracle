...
def demo2_impdb():
    ...
    execute(admin._imp_with_localfile,"oracle","gjzspt","gjzspt_demo2","/home/helong/TencentFiles/2898132719/FileRecv/20181116/20181116_165_2.dmp","Y","Y",hosts=['10.0.52.1'])
