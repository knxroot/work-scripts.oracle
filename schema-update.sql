...
alter table ALES_DAILY_ENFORCE_LAW modify (SCENE_PICTURE_NAMES varchar2(512));

alter table ALES_TASK_SAMPLE modify (ATTACHMENT_NAMES varchar2(512));

alter table ALES_PRODUCE_ADMIN_PUNISH modify (PUNISH_FILES_NAME varchar2(512));--检测系统 修改上传附件名称长度为1000
alter table ads_file modify (FILE_NAME varchar2(1000));

alter table ADS_MONITOR_SAMPLE modify (FILE_NAME varchar2(1000));--更改文件名长度
